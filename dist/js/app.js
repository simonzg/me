...
$('.sided-wrapper .image-wrapper img').mouseenter(function (e) {
  var link = $(e.target).parent().parent().find('.detail-link');
  link.addClass('active');
});
$('.sided-wrapper .image-wrapper img').mouseout(function (e) {
  var link = $(e.target).parent().parent().find('.detail-link');
  link.removeClass('active');
});
$('.sided-wrapper .image-wrapper').click(function (e) {
  var link = $(e.target).parent().parent().find('.detail-link');
...
=            Overlay            =
===============================*/
$('#overlay-open-btn').click(function () {
